...
class ListenAction(object):
    ...
    _feedback = paper_extended.msg.ListenFeedback()
    _result = paper_extended.msg.ListenResult()

    def __init__(self, name):
        self._action_name = name
        self._as = actionlib.SimpleActionServer(self._action_name, paper_extended.msg.ListenAction, execute_cb=self.execute_cb, auto_start = False)
        self._as.start()
